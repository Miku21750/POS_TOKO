    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-footer">
                ...
                <button class="btn btn-warning btn-flat" onclick="notaKecil('{{ route('transaksi.nota_faktur') }}', 'Nota Kecil')">Cetak Faktur</button>
                <button class="btn btn-warning btn-flat" onclick="notaKecil('{{ route('transaksi.nota_jalan') }}', 'Nota Kecil')">Cetak Surat Jalan</button>
                @else
